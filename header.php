...
<div id="header">
            ...
            <div class="row">
                ...
                <div class="account-section span5">
                    ...
                    <div class="not-logged visible">
                        <p><a href="#" class="login-button"><?php _e("CSG Login","um_lang"); ?></a></p>
                    </div>
                    <?php else: ?>
                    <div class="logged">
                        <p>
    ...
    <div class="mobile-menu-holder">
        <?php wp_nav_menu(array("mobile_menu" => "main_menu","menu_id"=>"mobile_menu","menu_class"=>"mobile_menu")); ?>
    </div>
    ...
    <div class="dialogs">
        ...
        <div class="login">
            ...
            <div class="l_holder">
                ...
                <form action="#" id="login-form">
                    ...
                    <p class="qw"><a href="#" onclick="show_forgot();" ><?php _e("Forgot Password?","um_lang"); ?></a></p>
                </form>
            </div>
        </div>
        ...
        <div class="messages">
            ...
            <div class="message_holder">
				<h4><i class="icon-user"></i><?php _e("Account Login Error","um_lang"); ?></h4>
