                    ...
                    var mlb = cm.createListBox('layout', {
                        ...
                        onselect : function(v) {
                            switch(v){
                                ...
                                case 'half_width' : tinyMCE.activeEditor.selection.setContent("[layout][layout_group][half_width]"+tinyMCE.activeEditor.selection.getContent() +"[/half_width][half_width]"+tinyMCE.activeEditor.selection.getContent() +"[/half_width][/layout_group][/layout]");break;
                                case 'one_third' : tinyMCE.activeEditor.selection.setContent("[layout][layout_group][one_third]"+tinyMCE.activeEditor.selection.getContent() +"[/one_third][one_third]"+tinyMCE.activeEditor.selection.getContent() +"[/one_third][one_third]"+tinyMCE.activeEditor.selection.getContent() +"[/one_third][/layout_group][/layout]");break;
                                case 'one_fourth' : tinyMCE.activeEditor.selection.setContent("[layout][layout_group][one_fourth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_fourth][one_fourth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_fourth][one_fourth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_fourth][one_fourth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_fourth][/layout_group][/layout]");break;
                                case 'one_sixth' : tinyMCE.activeEditor.selection.setContent("[layout][layout_group][one_sixth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_sixth][one_sixth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_sixth][one_sixth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_sixth][one_sixth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_sixth][one_sixth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_sixth][one_sixth]"+tinyMCE.activeEditor.selection.getContent() +"[/one_sixth][/layout_group][/layout]");break;
                            }
