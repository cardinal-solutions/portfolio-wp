...
?>
    ...
    <div class="add-post-top">
        <div class="container">
            <div class="row">
                <div class="span12"><h5><i class="icon-file-alt"></i><?php echo $curent_post_id ? __("Edit portolio post","um_lang") : __("Add a new portfolio post","um_lang"); ?></h5></div>
            </div>
        </div>
    </div>
                ...
                <div class="add-box span12">
                    ...
                    if($curent_post_id && current_user_can('edit_post', $curent_post_id)) :
                        ...
                        <div class="wp-in">
                            ...
                            <p><?php _e("<span style='color:red;'>*Important:</span> Choose the type of project and if it needs to be password protected:","um_lang"); ?></p>
                            <?php
                            ...
                            <p>&nbsp;</p><span style='color:red;'>*Important:</span> Add Tags:
                            <textarea name="post_tags" id="" cols="30" rows="10" placeholder="<?php _e("Enter company name and any other tags, seperate them with comma","um_lang"); ?> (,)"><?php echo $tags; ?></textarea>
                            ...
                            <div class="acf-image-uploader clearfix <?php echo has_post_thumbnail() ? "active" : ""; ?>" data-preview_size="thumbnail" data-library="all">
                                ...
                                <div class="no-image">
                                    <p><?php _e("<span style='color:red;'>*Important:</span> Choose Featured Image","um_lang"); ?> <input type="button" class="button add-image" value="<?php _e("Add Image","um_lang"); ?>">
                                    </p></div>
                            </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="wp-in">
                            ...
                            ?>
                            <p>&nbsp;</p><span style='color:red;'>*Important:</span> Add Tags:
                            <textarea name="post_tags" id="" cols="30" rows="10" placeholder="<?php _e("Enter company name and any other tags, seperate them with comma","um_lang"); ?> (,)"></textarea>
